...
const Badge = forwardRef<HTMLSpanElement, BadgeProps>(
  ({ className, variant = 'default', size = 'md', grade, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      security: 'bg-security-green/20 text-security-green border border-security-green/30',
    ...
    const gradeColors = {
      A: 'bg-security-green/20 text-security-green border border-security-green/30',
      B: 'bg-blue-100/20 text-blue-400 border border-blue-400/30',
      C: 'bg-yellow-100/20 text-yellow-400 border border-yellow-400/30',
      D: 'bg-orange-100/20 text-orange-400 border border-orange-400/30',
      F: 'bg-red-100/20 text-red-400 border border-red-400/30'
    }
